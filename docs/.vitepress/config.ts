    ...
    return [
        ...
        items: [
          ...
          { text: '理论框架', link: withLocale(locale, '/whitepaper/theoretical-framework') },
          {
            ...
            items: [
              ...
              { text: '借贷与杠杆的区别', link: withLocale(locale, '/whitepaper/protocol-mechanics/lending-vs-leverage') },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Margin 三方集成说明', link: withLocale(locale, '/integration/margin-integration') },
  ...
  return [
      ...
      items: [
        ...
        { text: 'Theoretical Framework', link: withLocale(locale, '/whitepaper/theoretical-framework') },
        {
          ...
          items: [
            ...
            { text: 'Lending vs. Leverage', link: withLocale(locale, '/whitepaper/protocol-mechanics/lending-vs-leverage') },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Margin Integration Guide', link: withLocale(locale, '/integration/margin-integration') },
